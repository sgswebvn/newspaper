...
<main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
   <div class="grid grid-cols-12 gap-4">
      ...
      <div class="col-span-9 border border-blue-200 p-4">
         <a href="{{ url('/news/details/' . $life[0]->id) }}">
            <div class="text-center mb-4">
               <img src="{{ asset('storage/'.$life[0]->hinh_anh) }}" alt="Image" class="w-full h-auto">
            </div>
            <h2 class="text-2xl font-bold text-blue-800">
            {{ $life[0]->tieu_de }}
            </h2>
            {!! Str::limit($life[0]->noi_dung, 800,  '...') !!}
      ...
      <div class="col-span-3 space-y-4">
         @foreach ($life->slice(1)->take(4) as $keyy)
