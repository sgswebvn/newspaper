...
<form method="POST" action="/add" enctype="multipart/form-data">
  ...
  <input type="text" name="tieu_de" placeholder="Nhập tiêu đề" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
  <br>
  @error('tieu_de')
  ...
  <textarea name="noi_dung" id="editor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" cols="30" rows="10"></textarea>
  <br>
  @error('noi_dung')
    <span class="badge badge-danger" style="color:red">{{ $message }}</span>
  @enderror
  ...
  <input type="text" name="tac_gia" placeholder="Tác giả" value="Hiếu Trương" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
  <br>
